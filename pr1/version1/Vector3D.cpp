...
ed::Vector3D ed::Vector3D::crossProduct(	ed::Vector3D const &v1,
																					ed::Vector3D const &v2) const {
	double x, y, z;
	x= 		(v1.get2()	*	v2.get3()) - 		(v1.get3()	*	v2.get2());
	y= (-	(v1.get1())	*	v2.get3()) + 		(v1.get3()	*	v2.get1());
	z= 		(v1.get1()	*	v2.get2()) - (-	(v1.get2())	*	v2.get1());
	Vector3D aux(x,y,z);
	return aux;
}
...
void ed::Vector3D::sumConst(ed::Vector3D vector, double diference){
