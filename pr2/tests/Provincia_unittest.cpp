...
TEST(Provincia,default_constructor){
	Provincia a;
	EXPECT_EQ("",a.get_name());
	EXPECT_EQ(0,a.get_code());
}

TEST(Provincia,parametrized_constructor){
	Provincia a("test",10);
	EXPECT_EQ("test",a.get_name());
	EXPECT_EQ(10,a.get_code());
}

TEST(Provincia,integration_test_no_1){
	Provincia a;
	Municipio municipio;
	Municipio municipio_head;
	a.load_data(csv_file_path);
...
TEST(Provincia,integration_test_no_2){
	Provincia a;
	a.set_code(1);
	a.set_name("Córdoba");
	EXPECT_EQ(1,a.get_code());
...
TEST(Provincia,integration_test_no_3){
	Provincia a;
	Municipio municipio;
	Municipio municipio_head;
	a.load_data(csv_file_path);
...
TEST(Provincia,integration_test_no_4){
	Provincia a;
	Municipio municipio;
	Municipio municipio_head;
	a.load_data(csv_file_path);
...
TEST(Provincia,integration_test_no_5){
	Provincia a;
	Municipio municipio_head;
	a.load_data(csv_file_path);
	a.goto_head();
...
TEST(Provincia,integration_test_no_6){
	Provincia a;
	Municipio municipio_head;
	Municipio municipio;
	a.load_data(csv_file_path);
